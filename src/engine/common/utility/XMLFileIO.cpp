...
bool Engine::XMLFileIO::OpenFile(const std::string& filename, XMLFile& out_XMLFile)
{
...
bool Engine::XMLFileIO::SaveFile(const std::string& filename, XMLFile& XMLFile)
{
...
Engine::XMLElement Engine::XMLFileIO::GetElement(XMLFile& file, const std::string& childElement)
{
	return file.FirstChildElement(childElement.c_str());
}

// Gets a child element of the specified element
Engine::XMLElement Engine::XMLFileIO::GetElement(const XMLElement& element, const std::string& childElement)
{
...
size_t Engine::XMLFileIO::GetElements(const XMLElement& element, const std::string& childElement, std::vector<XMLElement>& out_Elements)
{
	size_t count = 0;	
...
bool Engine::XMLFileIO::GetAttribute(const XMLElement& element, const std::string& attribute, std::string& out_String)
{
...
bool Engine::XMLFileIO::GetAttributeAsInteger(const XMLElement& element, const std::string& attribute, int& out_Value)
{
...
bool Engine::XMLFileIO::GetAttributeAsUnsignedInteger(const XMLElement& element, const std::string& attribute, unsigned int& out_Value)
{
...
bool Engine::XMLFileIO::GetAttributeAsBoolean(const XMLElement& element, const std::string& attribute, bool& out_Value)
{
...
bool Engine::XMLFileIO::GetAttributeAsDouble(const XMLElement& element, const std::string& attribute, double& out_Value)
{
...
bool Engine::XMLFileIO::GetAttributeAsFloat(const XMLElement& element, const std::string& attribute, float& out_Value)
{
...
bool Engine::XMLFileIO::GetText(const XMLElement& element, std::string& out_String)
{
...
bool Engine::XMLFileIO::GetTextAsInteger(const XMLElement& element, int& out_Value)
{
...
bool Engine::XMLFileIO::GetTextAsUnsignedInteger(const XMLElement& element, unsigned int& out_Value)
{
...
bool Engine::XMLFileIO::GetTextAsBoolean(const XMLElement& element, bool& out_Value)
{
...
bool Engine::XMLFileIO::GetTextAsDouble(const XMLElement& element, double& out_Value)
{
...
bool Engine::XMLFileIO::GetTextAsFloat(const XMLElement& element, float& out_Value)
{
...
void Engine::XMLFileIO::SetAttributeValue(XMLElement& element, const std::string& attribute, const std::string& value)
{
	element->SetAttribute(attribute.c_str(), value.c_str());
}

// Sets the textual content of an elements
void Engine::XMLFileIO::SetText(XMLElement& element, const std::string& string)
{
	element->SetText(string.c_str());
}

// Adds a new top level element to the file (returns the newly created element)
Engine::XMLElement Engine::XMLFileIO::AddElement(XMLFile& file, const std::string& childElement)
{
...
Engine::XMLElement Engine::XMLFileIO::AddElement(XMLElement& element, const std::string& childElement)
{
...
void Engine::XMLFileIO::DeleteElement(XMLFile& file, const std::string& childElement)
{
	file.DeleteChild(file.FirstChildElement(childElement.c_str()));
}

// Deletes a child element of the element
void Engine::XMLFileIO::DeleteElement(XMLElement& element, const std::string& childElement)
{
	element->DeleteChild(element->FirstChildElement(childElement.c_str()));
}

// Deletes an attribute of the element
void Engine::XMLFileIO::DeleteAttribute(XMLElement& element, const std::string& attribute)
{
